...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 30 nov. 2022 à 11:07
...
(1, '200', 'ULM', 'F-HTZZ', ' SportStar RTC', 2, '02:00:00.0000', 'Montauban'),
(2, '200', 'ULM', 'F-JFCF', ' SportStar RTC', 3, '02:00:00.0000', 'Toulouse'),
(4, '200', 'ULM', 'F-GRDF', ' SportStar RTC', 2, '02:00:00.0000', 'EN_VOL');
...
(33, 0, 0, 'corentin', '$2y$10$ds/7MPbk0wjDt2m8rOYTXujtVmmh/exO26Xj0vt0Q0DNtQDWntk42', NULL, 'coco@gmail.com', 632837031);
...
--
ALTER TABLE `avion`
  MODIFY `IDAVION` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `utilisateur`
--
ALTER TABLE `utilisateur`
  MODIFY `IDUTILISATEUR` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
COMMIT;
